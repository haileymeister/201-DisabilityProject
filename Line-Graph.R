...
line_graph_details <- paste0("To determine if there has been a change in the
    percentage of people with a disability in the Seattle Area, we made a
    line chart depicting this information between the years of 2010 to 2016.
    From this chart, we can determine that there has been a small change in
    this percentage from 57.6%  in 2010 to 59..83% in 2016. The overall trend
    is that the percent of the population with a disability increased during
    these years and has been higher than 50%. In 2011, the lowest percentage
    was reported while 2016 had the highest percentage reported. This chart
    does not account for type or number of disabilities but rather if an
    individual from this dataset in a certain year had any a disability.")
